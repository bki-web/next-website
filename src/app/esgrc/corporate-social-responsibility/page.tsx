...
export default function CorporateSocialResponsibility() {
    return (
        <div className="relative min-h-screen w-full overflow-hidden bg-white">
            ...
            <section
                className="relative isolate overflow-hidden bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950">
                {/* decorative blob */}
                <div
                    aria-hidden
                    className="pointer-events-none absolute -top-24 right-[-10%] h-72 w-72 rounded-full bg-sky-200/60 blur-3xl dark:bg-sky-500/10"
                />
            ...
            <span
                className="rounded-full bg-sky-100 px-3 py-1 text-xs font-medium tracking-wide text-sky-700 ring-1 ring-sky-200 dark:bg-sky-900/40 dark:text-sky-200 dark:ring-sky-800">
              Tahun 2007
            </span>
                            <span
                                className="text-xs text-slate-500 dark:text-slate-400">Corporate Social Responsibility</span>
                        </motion.div>

                        <motion.h2
                            variants={fadeIn}
                            className="text-2xl font-bold leading-tight text-slate-900 md:text-4xl dark:text-white"
                        >
                        ...
                        <motion.p
                            variants={fadeIn}
                            className="mt-4 max-w-3xl text-base leading-relaxed text-slate-600 md:text-lg dark:text-slate-300"
                        >
                            In 2007, the company allocated <strong
                            className="font-semibold text-slate-900 dark:text-white">Rp. 700,000,000,-</strong> for
                        ...
                        >
                            <div
                                ...
                                <div
                                    className="text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">Allocated
                                </div>
                                <div className="mt-1 text-2xl font-semibold text-slate-900 dark:text-white">Rp.
                                    700,000,000,-
                                </div>
                            </div>
                            <div
                                className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
                                <div
                                    className="text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">Source
                                </div>
                                <div className="mt-1 text-base font-medium text-slate-800 dark:text-slate-200">Profit
                            ...
                            <div
                                className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
                                <div
                                    className="text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">Focus
                                    Year
                                </div>
                                <div className="mt-1 text-base font-medium text-slate-800 dark:text-slate-200">2007
                                </div>
                            </div>
                        </motion.div>
                    </motion.header>
                    ...
                    >
                        ...
                        <motion.div variants={fadeIn} className="md:col-span-3">
                            <article className="prose prose-slate max-w-none prose-p:leading-relaxed dark:prose-invert">
                                <p>
                        ...
                        <motion.div variants={fadeIn} className="md:col-span-2">
                            <div className="sticky top-8 space-y-4">
                                <div
                                    ...
                                    <h3 className="text-sm font-semibold tracking-wide text-slate-900 dark:text-white">Program
                                        Outcomes</h3>
                                ...
                                <div
                                    className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
                                    <h3 className="text-sm font-semibold tracking-wide text-slate-900 dark:text-white">Priority
                                        (2007)</h3>
                ...
                <div
                    className="h-px w-full bg-gradient-to-r from-transparent via-sky-300/60 to-transparent dark:via-sky-700/30"/>
            </section>
        </div>
    )
}