...
import {Slide} from "@/app/our-services/tabs/tab-content";
...
const slides: Slide[] = [
    {
        ...
        title: "",
        headline: "Achieving Safe and Environmentally Sound Ship Recycling",
        body: "Partner with BKI to implement the IMO's Hong Kong Convention, ensuring recycling is conducted in a safe, controlled, and environmentally responsible manner.",
    },
    {
        image: "/our-services/classification/slider-2.jpg",
        title: "",
        headline: "The Certified IHM: Your Foundation for Compliance",
        body: "From initial development to the final verification of IHM Parts I, II, & III, we provide the expert support needed for full HKC compliance.",
    },
    {
        image: "/our-services/classification/slider-3.jpg",
        title: "",
        headline: "The Global Standard is Now in Force",
        body: "The Hong Kong Convention is the mandatory requirement for ship recycling. Partner with us to achieve full IHM certification for your fleet.",
    },
];
            ...
            <div className="relative w-full h-full">
                ...
                >
                    <motion.div
                        ...
                        animate="center"
                        exit="exit"
                        className="absolute inset-0 2xl:pb-52 2xl:pt-24 2xl:px-28 xl:px-24 pb-36 pt-12 px-12 flex flex-col justify-between items-end"
                        role="tabpanel"
                        aria-live="polite"
                        id={`panel-slider`}
                        key={`panel-slider`}
