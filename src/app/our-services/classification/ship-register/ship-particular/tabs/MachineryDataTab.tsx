...
const rows = [
    {
        left: {label: "Sistim Start (Starting Device of Main Engine)", value: "AKI (BATTERY)"},
...
export default function MachineryDataTab() {
    return (
        <div className="space-y-4">
            ...
            {/* MAIN ENGINE TABLE */}
            <h3 className="mt-2 text-lg md:text-xl font-semibold text-slate-900">MAIN ENGINE</h3>
            <SimpleTable columns={mainCols} data={mainData}/>

            {/* AUXILIARY ENGINE TABLE */}
            <h3 className="mt-4 text-lg md:text-xl font-semibold text-slate-900">AUXILIARY ENGINE</h3>
