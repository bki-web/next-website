...
export default function AboutUs() {
  return (
    <section className="relative w-full h-auto md:h-screen flex items-center justify-center py-10 md:py-0">
      ...
      {/* Content */}
      <div className="relative z-10 px-6 md:px-24 text-center text-white space-y-6 font-medium md:flex md:items-center md:text-left md:space-y-0 md:space-x-12">
