            ...
            >
                <div className="flex flex-col gap-7 px-10 2xl:px-[105px]">
                    ...
                    <p className="2xl:text-2xl">
                        Meet the strategic minds actively guiding the strategic growth of BKI, driving innovation and
                        positioning our organization to lead in an era of profound industrial transformation.
                    </p>
                </div>
