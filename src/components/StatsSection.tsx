                ...
                <div className="space-y-16">
                    ...
                    <div className="w-full">
                        <div className="text-center mb-12">
                            <h3 className="text-3xl md:text-4xl font-bold text-[#26476c] mb-4">Organizational
                                Overview</h3>
                                    ...
                                    >
                                        <CardContent className="p-8 text-center">
                                            <div className="flex flex-col items-center gap-6">
                                                ...
                                                <div>
                                                    <div
                                                        className="text-5xl md:text-6xl font-bold text-[#26476c] mb-2">{stat.number}</div>
                                                    <div
                                                        className="text-lg text-gray-600 font-medium">{stat.label}</div>
                                                </div>
                                            </div>
                                        </CardContent>
                                    </Card>
                    ...
                    <div className="text-center py-8 border-t border-gray-200">
                        ...
                        <p className="text-sm text-gray-500">
                            Committed to maintaining the highest standards of maritime safety and environmental
                            protection
                        </p>
                    </div>
                </div>
