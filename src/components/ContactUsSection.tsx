...
export default function ContactUsSection() {
    ...
    return (
        ...
        >
            <div
                className="relative w-full xl:p-12 md:p-10 p-8 flex xl:flex-row flex-col justify-center items-center bg-gradient-to-b from-[#0A436A] to-black min-h-[50vh]">
                <Image
                ...
                />
                <div className="flex w-full xl:w-[unset] xl:min-h-[50vh] flex-col justify-between gap-4">
                    ...
                    <div
                        ...
                        <div className="flex items-center 2xl:gap-6 md:gap-5 gap-4 z-1">
                            ...
                            <Link
                                href={"https://www.tiktok.com/@bkiacademy"}
                                target={"_blank"}
                                className="rounded-full flex justify-center items-center p-1.5 bg-white/60 transition-all duration-500 ease-in-out hover:shadow-[0_0_7px_0_#ffffff] hover:shadow-white/80"
                            >
                                <Image
                            ...
                            <Link
                                href={"https://www.facebook.com/BKI1964/?locale=id_ID"}
                                target={"_blank"}
                                className="rounded-full flex justify-center items-center p-1.5 bg-white/60 transition-all duration-500 ease-in-out hover:shadow-[0_0_7px_0_#ffffff] hover:shadow-white/80"
                            >
                                <Image
