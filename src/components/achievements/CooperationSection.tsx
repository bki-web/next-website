                ...
                <div className="container mx-auto px-4 lg:px-0 flex flex-col gap-10">
                    ...
                    <div className="mt-10 flex flex-col gap-2">
                        ...
                        <div className="container flex flex-col text-base md:text-2xl font-bold">
                            ...
                            <div
                                className="h-[1px] bg-gradient-to-r from-white to-transparent w-full md:w-3/4 mb-6"></div>
                            ...
                            {classificationData.map((item, index) => (
                                ...
                                >
                                    ...
                                    {item.images && item.images.length > 0 && (
                                        <div
                                            className="flex flex-wrap justify-center md:justify-start gap-2 md:gap-3 mt-3">
