        ...
        >
            ...
            {!hideText && (
                <>
                    ...
                    >
                        <div
                            className="font-montserrat text-4xl text-shadow-xs text-shadow-black/50 md:text-6xl leading-none font-extrabold flex items-center gap-2">
                            {slide.topTitle ?? "Why"}
                        </div>
                        <div
                            className="mt-2 text-xl md:text-4xl font-mediu text-shadow-xs text-shadow-black/50 flex items-center gap-2">
                    ...
                    >
                        <div
                            className="text-2xl text-shadow-xs text-shadow-black/50 md:text-4xl font-extrabold leading-[1.05] md:w-[50vw] text-left ">
                            {slide.bottomRight}
