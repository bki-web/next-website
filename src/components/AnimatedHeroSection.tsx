    ...
    return (
        <section className="relative h-screen overflow-hidden">
            ...
            <div className={`fixed inset-0 z-40 lg:hidden transition-all duration-300 ${
                ...
                {/* Mobile Menu */}
                <div
                    className={`mobile-menu absolute top-0 right-0 h-full w-80 max-w-[85vw] bg-white shadow-2xl transform transition-transform duration-300 ease-out ${
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="space-y-6">
                            ...
                            <div
                                className={`flex flex-col sm:flex-row gap-4 pt-8 justify-center transform transition-all duration-1200 ease-out ${
                                    animationStage >= 4 ? 'opacity-100 translate-y-0 scale-100 delay-700' : 'opacity-0 translate-y-12 scale-95'
                                }`}>
                                <button
                                    className="bg-[#ecb143] hover:bg-[#ecb143]/90 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:-translate-y-1 active:scale-95">
            ...
            {/* Scroll Indicator */}
            <div
                className={`hidden md:block absolute bottom-8 right-8 z-20 animate-bounce hover:animate-pulse cursor-pointer transition-all duration-1000 ease-out ${
