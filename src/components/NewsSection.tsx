...
import {Anchor, ArrowRight, Award, Calendar, Clock, Globe, Shield} from "lucide-react"
            ...
            <div className="relative z-10 max-w-7xl mx-auto flex-1 flex flex-col">
                ...
                {regularNews.length > 0 && (
                    <div className="flex-1">
                        ...
                        <span
                            className="bg-white/90 backdrop-blur-sm text-[#26476c] px-2 py-1 rounded-full text-xs font-medium flex items-center gap-1">
                          <CategoryIcon className="w-3 h-3"/>
                            {news.category}
                              ...
                              {tag}
                                                ...
                                                <button
                                                    className="flex items-center gap-1 text-[#26476c] font-medium text-sm hover:gap-2 transition-all duration-200">
                                                    Read
