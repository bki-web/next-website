...
export default async function NewsSection2() {
    ...
    return (
        ...
        >
            <div
                className="flex flex-col md:flex-row items-center gap-6 bg-[#00385A] bg-opacity-25 border-2 border-white border-opacity-50 rounded py-4 px-6 mb-10 relative -top-6">
                <div
                    className="pl-2 font-medium text-xl md:text-2xl 2xl:text-4xl w-full md:w-1/3 text-center md:text-left">
                    What are you looking for?
                </div>
                <input
                    type="text"
                    placeholder="Type something here"
                    className="w-full bg-transparent outline-none px-2 border-b border-white text-lg md:text-xl 2xl:text-3xl placeholder:text-lg md:placeholder:text-xl 2xl:placeholder:text-3xl"
                />
                <button
                    className="w-full md:w-auto px-4 py-2 bg-[#0A436A] border border-white cursor-pointer rounded hover:bg-[#0A436A]/50">
                    Search
                </button>
            </div>
