...
export default function HeroPublication(props: Props) {
    ...
    return (
        ...
        >
            ...
            />
            <div
                className="w-full relative flex flex-col justify-center items-start px-6 md:px-24 py-24 2xl:pt-40 text-center text-white text-shadow-lg text-shadow-black/30">
